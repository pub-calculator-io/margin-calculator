...
Version: 1.0.0
Author: Margin Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Margin Calculator by www.calculator.io";

function display_calcio_ci_margin_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_margin_calculator', 'display_calcio_ci_margin_calculator' );